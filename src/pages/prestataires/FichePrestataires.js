      ...
      <div className="flex h-screen flex-col text-center">
        <div className="m-auto">
          <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <img className="object-none object-center rounded-t-lg" src="https://picsum.photos/200/300" alt="" />
            <div className="p-5">
              <a href="#">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white uppercase">{prestataire.name}</h5>
              </a>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{prestataire.description}</p>
              <div className="flex">
